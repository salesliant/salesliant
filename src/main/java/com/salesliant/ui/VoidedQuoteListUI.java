...
public class VoidedQuoteListUI extends BaseListUI<VoidedTransaction> {
    ...
    private void loadData() {
        ...
        Platform.runLater(() -> {
            List<VoidedTransaction> list = daoVoidedTransaction.readBetweenDate(VoidedTransaction_.store, Config.getStore(),
                    VoidedTransaction_.transactionType, DBConstants.TYPE_VOID_QUOTE,

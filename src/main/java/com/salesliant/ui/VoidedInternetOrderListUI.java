...
public class VoidedInternetOrderListUI extends BaseListUI<VoidedTransaction> {
    ...
    public VoidedInternetOrderListUI() {
        setDefaultDate();
        loadData();
    ...
    private void loadData() {
        ...
        Platform.runLater(() -> {
            List<VoidedTransaction> list = daoVoidedTransaction.readBetweenDate(VoidedTransaction_.store, Config.getStore(),
                    VoidedTransaction_.transactionType, DBConstants.TYPE_VOID_INTERNET_ORDER,

...
/**
 *
 * <p>Title: ServiceCode</p>
 *
 * <p>Description: Domain Object describing a ServiceCode entity</p>
 *
 */
@Entity (name="ServiceCode")
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-code@
    @Column(name="code"  , length=32 , nullable=true , unique=false)
    private String code; 
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @serviceEntries-field-service_code@
    @OneToMany (targetEntity=com.salesliant.entity.ServiceEntry.class, fetch=FetchType.LAZY, mappedBy="serviceCode", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @serviceEntries-getter-service_code@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-service_code@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-service_code@

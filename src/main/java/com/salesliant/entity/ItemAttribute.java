...
/**
 *
 * <p>Title: ItemAttribute</p>
 *
 * <p>Description: Domain Object describing a ItemAttribute entity</p>
 *
 */
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    @ManyToOne (fetch=FetchType.LAZY , optional=false)
    @JoinColumn(name="item_attribute_value_id", referencedColumnName = "id" , nullable=false , unique=false , insertable=true, updatable=true) 
    private ItemAttributeValue itemAttributeValue;  

    @Column(name="item_attribute_value_id"  , nullable=false , unique=false, insertable=false, updatable=false)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    public void setItemAttributeValueId (Integer itemAttributeValue) {
        this.itemAttributeValueId =  itemAttributeValue;
    }
	


//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-item_attribute@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-item_attribute@

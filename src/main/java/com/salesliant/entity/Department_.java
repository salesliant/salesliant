...
public class Department_ {
    ...
    public static volatile SingularAttribute<Department, String> webDescription;
    public static volatile SingularAttribute<Department, Integer> master;
    public static volatile SingularAttribute<Department, Integer> version;


    public static volatile ListAttribute<Department, Item> items;

 ...
 * <p>Title: MailGroup</p>
 *
 * <p>Description: Domain Object describing a MailGroup entity</p>
 *
 */
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @employees-field-mail_group@
    @OneToMany (targetEntity=com.salesliant.entity.Employee.class, fetch=FetchType.LAZY, mappedBy="mailGroup", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @employees-getter-mail_group@

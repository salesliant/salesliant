...
/**
 *
 * <p>Title: TransferOrderHistory</p>
 *
 * <p>Description: Domain Object describing a TransferOrderHistory entity</p>
 *
 */
@Entity (name="TransferOrderHistory")
@Table (name="transfer_order_history")
//MP-MANAGED-ADDED-AREA-BEGINNING @custom-annotations@
//MP-MANAGED-ADDED-AREA-ENDING @custom-annotations@
public class TransferOrderHistory implements Serializable {
    private static final long serialVersionUID = 1L;
	public static final java.math.BigDecimal __DEFAULT_TOTAL = java.math.BigDecimal.valueOf(0.0000);
	public static final java.math.BigDecimal __DEFAULT_FREIGHT_AMOUNT = java.math.BigDecimal.valueOf(0.0000);
...
//MP-MANAGED-ADDED-AREA-BEGINNING @send_store_name-field-annotation@
//MP-MANAGED-ADDED-AREA-ENDING @send_store_name-field-annotation@
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-send_store_name@
    @Column(name="send_store_name"  , length=64 , nullable=true , unique=false)
    private String sendStoreName; 
//MP-MANAGED-UPDATABLE-ENDING

//MP-MANAGED-ADDED-AREA-BEGINNING @receive_store_name-field-annotation@
//MP-MANAGED-ADDED-AREA-ENDING @receive_store_name-field-annotation@
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-receive_store_name@
    @Column(name="receive_store_name"  , length=64 , nullable=true , unique=false)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemLogs-field-transfer_order_history@
    @OneToMany (targetEntity=com.salesliant.entity.ItemLog.class, fetch=FetchType.LAZY, mappedBy="transferOrderHistory", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
    private List <ItemLog> itemLogs = new ArrayList<>(); 

//MP-MANAGED-UPDATABLE-ENDING
//MP-MANAGED-UPDATABLE-BEGINNING-ENABLE @transferOrderHistoryEntries-field-transfer_order_history@
    @OneToMany (targetEntity=com.salesliant.entity.TransferOrderHistoryEntry.class, fetch=FetchType.LAZY, mappedBy="transferOrderHistory", cascade=CascadeType.ALL, orphanRemoval = true)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @GETTER-SETTER-send_store_name@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @GETTER-SETTER-receive_store_name@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemLogs-getter-transfer_order_history@
...
//MP-MANAGED-UPDATABLE-ENDING
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @transferOrderHistoryEntries-getter-transfer_order_history@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-transfer_order_history@
    @javax.persistence.PrePersist
    public void prePersist_ () {
        if (total==null) total=__DEFAULT_TOTAL;
        if (freightAmount==null) freightAmount=__DEFAULT_FREIGHT_AMOUNT;
        if (version==null) version=__DEFAULT_VERSION;
    }
//MP-MANAGED-UPDATABLE-ENDING

//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-transfer_order_history@

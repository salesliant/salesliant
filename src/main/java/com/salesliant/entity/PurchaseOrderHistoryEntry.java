...
/**
 *
 * <p>Title: PurchaseOrderHistoryEntry</p>
 *
 * <p>Description: Domain Object describing a PurchaseOrderHistoryEntry entity</p>
 *
 */
@Entity (name="PurchaseOrderHistoryEntry")
@Table (name="purchase_order_history_entry")
//MP-MANAGED-ADDED-AREA-BEGINNING @custom-annotations@
//MP-MANAGED-ADDED-AREA-ENDING @custom-annotations@
public class PurchaseOrderHistoryEntry implements Serializable {
    private static final long serialVersionUID = 1L;
	public static final java.math.BigDecimal __DEFAULT_QUANTITY_ORDERED = java.math.BigDecimal.valueOf(0.0000);
	public static final java.math.BigDecimal __DEFAULT_QUANTITY_IN_STOCK = java.math.BigDecimal.valueOf(0.0000);
	public static final java.math.BigDecimal __DEFAULT_QUANTITY_RECEIVED = java.math.BigDecimal.valueOf(0.0000);
	public static final java.math.BigDecimal __DEFAULT_QUANTITY_TRANSFERRED = java.math.BigDecimal.valueOf(0.0000);
	public static final java.math.BigDecimal __DEFAULT_QUANTITY_PER_UOM = java.math.BigDecimal.valueOf(0.0000);
	...
	public static final java.math.BigDecimal __DEFAULT_FREIGHT = java.math.BigDecimal.valueOf(0.0000);
...
//MP-MANAGED-ADDED-AREA-BEGINNING @quantity_in_stock-field-annotation@
//MP-MANAGED-ADDED-AREA-ENDING @quantity_in_stock-field-annotation@
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-quantity_in_stock@
    @Column(name="quantity_in_stock"   , nullable=true , unique=false)
    private java.math.BigDecimal quantityInStock; 
//MP-MANAGED-UPDATABLE-ENDING
...
//MP-MANAGED-ADDED-AREA-BEGINNING @quantity_transferred-field-annotation@
//MP-MANAGED-ADDED-AREA-ENDING @quantity_transferred-field-annotation@
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-quantity_transferred@
    @Column(name="quantity_transferred"   , nullable=true , unique=false)
    private java.math.BigDecimal quantityTransferred; 
//MP-MANAGED-UPDATABLE-ENDING
...
//MP-MANAGED-ADDED-AREA-BEGINNING @freight-field-annotation@
//MP-MANAGED-ADDED-AREA-ENDING @freight-field-annotation@
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-freight@
    @Column(name="freight"   , nullable=true , unique=false)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @ATTRIBUTE-category_name@
    @Column(name="category_name"  , length=32 , nullable=true , unique=false)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    @JoinColumn(name="purchase_order_history_id", referencedColumnName = "id" , nullable=false , unique=true  , insertable=true, updatable=true) 
    private PurchaseOrderHistory purchaseOrderHistory;  

    @Column(name="purchase_order_history_id"  , nullable=false , unique=true, insertable=false, updatable=false)
...
//MP-MANAGED-UPDATABLE-BEGINNING-ENABLE @serialNumbers-field-purchase_order_history_entry@
    @OneToMany (targetEntity=com.salesliant.entity.SerialNumber.class, fetch=FetchType.LAZY, mappedBy="purchaseOrderHistoryEntry", cascade=CascadeType.DETACH)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    * Default constructor
    */
    public PurchaseOrderHistoryEntry() {
    }
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @GETTER-SETTER-quantity_in_stock@
    public java.math.BigDecimal getQuantityInStock() {
        return quantityInStock;
    }
	
    public void setQuantityInStock (java.math.BigDecimal quantityInStock) {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @GETTER-SETTER-quantity_transferred@
    public java.math.BigDecimal getQuantityTransferred() {
        return quantityTransferred;
    }
	
    public void setQuantityTransferred (java.math.BigDecimal quantityTransferred) {
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @GETTER-SETTER-freight@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @serialNumbers-getter-purchase_order_history_entry@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-purchase_order_history_entry@
    @javax.persistence.PrePersist
    public void prePersist_ () {
        if (quantityOrdered==null) quantityOrdered=__DEFAULT_QUANTITY_ORDERED;
        if (quantityInStock==null) quantityInStock=__DEFAULT_QUANTITY_IN_STOCK;
        if (quantityReceived==null) quantityReceived=__DEFAULT_QUANTITY_RECEIVED;
        if (quantityTransferred==null) quantityTransferred=__DEFAULT_QUANTITY_TRANSFERRED;
        ...
        if (freight==null) freight=__DEFAULT_FREIGHT;
        if (version==null) version=__DEFAULT_VERSION;
    }
//MP-MANAGED-UPDATABLE-ENDING

//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-purchase_order_history_entry@

...
/**
 *
 * <p>Title: BinLocation</p>
 *
 * <p>Description: Domain Object describing a BinLocation entity</p>
 *
 */
@Entity (name="BinLocation")
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemLocations-field-bin_location@
    @OneToMany (targetEntity=com.salesliant.entity.ItemLocation.class, fetch=FetchType.LAZY, mappedBy="binLocation", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemLocations-getter-bin_location@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-bin_location@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-bin_location@

...
public class SubCategory_ {
    ...
    public static volatile SingularAttribute<SubCategory, String> code;
    public static volatile SingularAttribute<SubCategory, String> description;
    public static volatile SingularAttribute<SubCategory, Integer> version;


    public static volatile SingularAttribute<SubCategory, Category> category;
    public static volatile SingularAttribute<SubCategory, Integer> category_;

    public static volatile SingularAttribute<SubCategory, Store> store;
    public static volatile SingularAttribute<SubCategory, Integer> store_;

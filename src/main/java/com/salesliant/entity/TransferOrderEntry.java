...
/**
 *
 * <p>Title: TransferOrderEntry</p>
 *
 * <p>Description: Domain Object describing a TransferOrderEntry entity</p>
 *
 */
@Entity (name="TransferOrderEntry")
@Table (name="transfer_order_entry")
//MP-MANAGED-ADDED-AREA-BEGINNING @custom-annotations@
//MP-MANAGED-ADDED-AREA-ENDING @custom-annotations@
public class TransferOrderEntry implements Serializable {
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    @Column(name="item_id"  , nullable=true , unique=false, insertable=false, updatable=false)
    private Integer itemId;

    @ManyToOne (fetch=FetchType.LAZY )
    @JoinColumn(name="transfer_order_id", referencedColumnName = "id" , nullable=true , unique=false , insertable=true, updatable=true) 
    private TransferOrder transferOrder;  

    @Column(name="transfer_order_id"  , nullable=true , unique=false, insertable=false, updatable=false)
    private Integer transferOrderId;

//MP-MANAGED-UPDATABLE-BEGINNING-ENABLE @serialNumbers-field-transfer_order_entry@
    @OneToMany (targetEntity=com.salesliant.entity.SerialNumber.class, fetch=FetchType.LAZY, mappedBy="transferOrderEntry", cascade=CascadeType.DETACH)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    public void setTransferOrderId (Integer transferOrder) {
        this.transferOrderId =  transferOrder;
    }
	

//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @serialNumbers-getter-transfer_order_entry@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-transfer_order_entry@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-transfer_order_entry@

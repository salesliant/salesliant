 ...
 * <p>Title: ItemBom</p>
 *
 * <p>Description: Domain Object describing a ItemBom entity</p>
 *
 */
@Entity (name="ItemBom")
@Table (name="item_bom")
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    @JoinColumn(name="bom_item_id", referencedColumnName = "id" , nullable=false , unique=false , insertable=true, updatable=true) 
    private Item bomItem;  

    @Column(name="bom_item_id"  , nullable=false , unique=false, insertable=false, updatable=false)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    public void setBomItemId (Integer bomItem) {
        this.bomItemId =  bomItem;
    }
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-item_bom@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-item_bom@

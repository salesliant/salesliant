...
/**
 *
 * <p>Title: ItemAttributeValue</p>
 *
 * <p>Description: Domain Object describing a ItemAttributeValue entity</p>
 *
 */
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    @JoinColumn(name="item_attribute_type_id", referencedColumnName = "id" , nullable=false , unique=false , insertable=true, updatable=true) 
    private ItemAttributeType itemAttributeType;  

    @Column(name="item_attribute_type_id"  , nullable=false , unique=false, insertable=false, updatable=false)
    private Integer itemAttributeTypeId;

//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemAttributes-field-item_attribute_value@
    @OneToMany (targetEntity=com.salesliant.entity.ItemAttribute.class, fetch=FetchType.LAZY, mappedBy="itemAttributeValue", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
...
//MP-MANAGED-UPDATABLE-ENDING
    ...
    public void setItemAttributeTypeId (Integer itemAttributeType) {
        this.itemAttributeTypeId =  itemAttributeType;
    }
	

//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @itemAttributes-getter-item_attribute_value@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @prepersist-item_attribute_value@
...
//MP-MANAGED-UPDATABLE-BEGINNING-DISABLE @preupdate-item_attribute_value@

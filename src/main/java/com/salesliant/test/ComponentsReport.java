...
import com.salesliant.report.Templates;
...
public class ComponentsReport {
    ...
    /**
     * <p>
     * Constructor for ComponentsReport.</p>
     */
    ...
    private void build() {
        ...
        try {
            report().setTemplate(template().setBarcodeHeight(50))
                    ...
                    .title(components("rectangle", cmp.rectangle(), "round rectangle", cmp.roundRectangle(10), "ellipse", cmp.ellipse()),
